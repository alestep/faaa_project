	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnRegister.setOnClickListener(new View.OnClickListener() {			
			public void onClick(View view) {
				...
				// Checking if name, email or password is set incorrectly
				// Use an array later to store error messages and print them more elegantly

				if(name == null || name.length() == 0) {
					registerErrorMsg.setText("Please enter a valid name");
				} else if (!goodEmailFormat.matcher(email).matches()) {
					registerErrorMsg.setText("Please enter a valid email");
