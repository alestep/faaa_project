	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (game != null) {
			...
			if (position == 0) {
				...
				v = li.inflate(R.layout.list_item_game_top, null);
				...
				if(subtitle != null) {
					...
					subtitle.setText("Score: " + currentPlayerScore + " - " + opponentScore);

				}
			} else if(position == games.size()-1) {
				v = li.inflate(R.layout.list_item_game_bottom, null);
				final TextView title = (TextView) v.findViewById(R.id.opponent);
				final TextView subtitle = (TextView) v.findViewById(R.id.score);
