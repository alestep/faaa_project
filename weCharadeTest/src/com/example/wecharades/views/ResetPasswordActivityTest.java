...
/**
 * The class <code>ResetPasswordActivityTest</code> contains tests for the class <code>{@link ResetPasswordActivity}</code>.
 *
...
public class ResetPasswordActivityTest {
	...
	public void testGetProgressBar_1()
		throws Exception {
		ResetPasswordActivity fixture = new ResetPasswordActivity();
	...
	/**
	 * Run the void onClickBack(View) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 2013-05-29 09:38
	 */
	@Test
	public void testOnClickBack_1()
		throws Exception {
		ResetPasswordActivity fixture = new ResetPasswordActivity();
		fixture.presenter = new AccountPresenter(new AccountActivity());
		View v = new View(new CaptureVideoActivity());

		fixture.onClickBack(v);
	...
	/**
	 * Run the void onClickResetPassword(View) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 2013-05-29 09:38
	 */
	@Test
	public void testOnClickResetPassword_1()
		throws Exception {
		ResetPasswordActivity fixture = new ResetPasswordActivity();
		fixture.presenter = new AccountPresenter(new AccountActivity());
		View view = new View(new CaptureVideoActivity());

		fixture.onClickResetPassword(view);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(ResetPasswordActivityTest.class);
	}
}