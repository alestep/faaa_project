...
/**
 * The class <code>SearchPlayerActivityTest</code> contains tests for the class <code>{@link SearchPlayerActivity}</code>.
 *
 * @generatedBy CodePro at 2013-05-29 09:38
 * @author felixkarlsson
 * @version $Revision: 1.0 $
 */
public class SearchPlayerActivityTest {
	/**
	...
	public void testGetProgressBar_1()
		throws Exception {
		SearchPlayerActivity fixture = new SearchPlayerActivity();
	...
	/**
	 * Run the void onClickSearch(View) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 2013-05-29 09:38
	 */
	@Test
	public void testOnClickSearch_1()
		throws Exception {
		SearchPlayerActivity fixture = new SearchPlayerActivity();
		fixture.presenter = new AccountPresenter(new AccountActivity());
		View view = new View(new CaptureVideoActivity());

		fixture.onClickSearch(view);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(SearchPlayerActivityTest.class);
	}
}