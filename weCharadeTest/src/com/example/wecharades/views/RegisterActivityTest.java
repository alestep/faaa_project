...
/**
 * The class <code>RegisterActivityTest</code> contains tests for the class <code>{@link RegisterActivity}</code>.
 *
...
public class RegisterActivityTest {
	...
	public void testGetProgressBar_1()
		throws Exception {
		RegisterActivity fixture = new RegisterActivity();
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(RegisterActivityTest.class);
	}
}